...
#endif`,_d="gl_FragColor = linearToOutputTexel( gl_FragColor );",gd=`vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
void main() {
	...
	`}function L0(o){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===Ir||l===Ar,u=l===Fi||l===Gi;if(c||u){let h=e.get(a);const p=h!==void 0?h.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==p)return t===null&&(t=new Pl(o)),h=c?t.fromEquirectangular(a,h):t.fromCubemap(a,h),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),h.texture;if(h!==void 0)return h.texture;{const f=a.image;return c&&f&&f.height>0||u&&f&&i(f)?(t===null&&(t=new Pl(o)),h=c?t.fromEquirectangular(a):t.fromCubemap(a),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),a.addEventListener("dispose",s),h.texture):null}}}return a}function i(a){let l=0;const c=6;for(let u=0;u<c;u++)a[u]!==void 0&&l++;return l===c}function s(a){const l=a.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function r(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:r}}function R0(o){const e={};function t(n){if(e[n]!==void 0)return e[n];let i;switch(n){case"WEBGL_depth_texture":i=o.getExtension("WEBGL_depth_texture")||o.getExtension("MOZ_WEBGL_depth_texture")||o.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=o.getExtension("EXT_texture_filter_anisotropic")||o.getExtension("MOZ_EXT_texture_filter_anisotropic")||o.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=o.getExtension("WEBGL_compressed_texture_s3tc")||o.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||o.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=o.getExtension("WEBGL_compressed_texture_pvrtc")||o.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=o.getExtension(n)}return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const i=t(n);return i===null&&Ni("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function w0(o,e,t,n){const i={},s=new WeakMap;function r(h){const p=h.target;p.index!==null&&e.remove(p.index);for(const _ in p.attributes)e.remove(p.attributes[_]);p.removeEventListener("dispose",r),delete i[p.id];const f=s.get(p);f&&(e.remove(f),s.delete(p)),n.releaseStatesOfGeometry(p),p.isInstancedBufferGeometry===!0&&delete p._maxInstanceCount,t.memory.geometries--}function a(h,p){return i[p.id]===!0||(p.addEventListener("dispose",r),i[p.id]=!0,t.memory.geometries++),p}function l(h){const p=h.attributes;for(const f in p)e.update(p[f],o.ARRAY_BUFFER)}function c(h){const p=[],f=h.index,_=h.attributes.position;let g=0;if(f!==null){const T=f.array;g=f.version;for(let v=0,E=T.length;v<E;v+=3){const C=T[v+0],N=T[v+1],S=T[v+2];p.push(C,N,N,S,S,C)}}else if(_!==void 0){const T=_.array;g=_.version;for(let v=0,E=T.length/3-1;v<E;v+=3){const C=v+0,N=v+1,S=v+2;p.push(C,N,N,S,S,C)}}else return;const m=new(Rc(p)?Uc:Pc)(p,1);m.version=g;const d=s.get(h);d&&e.remove(d),s.set(h,m)}function u(h){const p=s.get(h);if(p){const f=h.index;f!==null&&p.version<f.version&&c(h)}else c(h);return s.get(h)}return{get:a,update:l,getWireframeAttribute:u}}function C0(o,e,t){let n;function i(p){n=p}let s,r;function a(p){s=p.type,r=p.bytesPerElement}function l(p,f){o.drawElements(n,f,s,p*r),t.update(f,n,1)}function c(p,f,_){_!==0&&(o.drawElementsInstanced(n,f,s,p*r,_),t.update(f,n,_))}function u(p,f,_){if(_===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,s,p,0,_);let m=0;for(let d=0;d<_;d++)m+=f[d];t.update(m,n,1)}function h(p,f,_,g){if(_===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let d=0;d<p.length;d++)c(p[d]/r,f[d],g[d]);else{m.multiDrawElementsInstancedWEBGL(n,f,0,s,p,0,g,0,_);let d=0;for(let T=0;T<_;T++)d+=f[T]*g[T];t.update(d,n,1)}}this.setMode=i,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function D0(o){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,r,a){switch(t.calls++,r){case o.TRIANGLES:t.triangles+=a*(s/3);break;case o.LINES:t.lines+=a*(s/2);break;case o.LINE_STRIP:t.lines+=a*(s-1);break;case o.LINE_LOOP:t.lines+=a*s;break;case o.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",r);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:n}}function P0(o,e,t){const n=new WeakMap,i=new qe;function s(r,a,l){const c=r.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,h=u!==void 0?u.length:0;let p=n.get(a);if(p===void 0||p.count!==h){let y=function(){U.dispose(),n.delete(a),a.removeEventListener("dispose",y)};var f=y;p!==void 0&&p.texture.dispose();const _=a.morphAttributes.position!==void 0,g=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,d=a.morphAttributes.position||[],T=a.morphAttributes.normal||[],v=a.morphAttributes.color||[];let E=0;_===!0&&(E=1),g===!0&&(E=2),m===!0&&(E=3);let C=a.attributes.position.count*E,N=1;C>e.maxTextureSize&&(N=Math.ceil(C/e.maxTextureSize),C=e.maxTextureSize);const S=new Float32Array(C*N*4*h),U=new Cc(S,C,N,h);U.type=Qt,U.needsUpdate=!0;const I=E*4;for(let R=0;R<h;R++){const z=d[R],G=T[R],j=v[R],K=C*N*4*R;for(let X=0;X<z.count;X++){const Z=X*I;_===!0&&(i.fromBufferAttribute(z,X),S[K+Z+0]=i.x,S[K+Z+1]=i.y,S[K+Z+2]=i.z,S[K+Z+3]=0),g===!0&&(i.fromBufferAttribute(G,X),S[K+Z+4]=i.x,S[K+Z+5]=i.y,S[K+Z+6]=i.z,S[K+Z+7]=0),m===!0&&(i.fromBufferAttribute(j,X),S[K+Z+8]=i.x,S[K+Z+9]=i.y,S[K+Z+10]=i.z,S[K+Z+11]=j.itemSize===4?i.w:1)}}p={count:h,texture:U,size:new ye(C,N)},n.set(a,p),a.addEventListener("dispose",y)}if(r.isInstancedMesh===!0&&r.morphTexture!==null)l.getUniforms().setValue(o,"morphTexture",r.morphTexture,t);else{let _=0;for(let m=0;m<c.length;m++)_+=c[m];const g=a.morphTargetsRelative?1:1-_;l.getUniforms().setValue(o,"morphTargetBaseInfluence",g),l.getUniforms().setValue(o,"morphTargetInfluences",c)}l.getUniforms().setValue(o,"morphTargetsTexture",p.texture,t),l.getUniforms().setValue(o,"morphTargetsTextureSize",p.size)}return{update:s}}function U0(o,e,t,n){let i=new WeakMap;function s(l){const c=n.render.frame,u=l.geometry,h=e.get(l,u);if(i.get(h)!==c&&(e.update(h),i.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),i.get(l)!==c&&(t.update(l.instanceMatrix,o.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,o.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const p=l.skeleton;i.get(p)!==c&&(p.update(),i.set(p,c))}return h}function r(){i=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:r}}const $c=new _t,Fl=new Yc(1,1),Jc=new Cc,eu=new Nh,tu=new Fc,Gl=[],Bl=[],kl=new Float32Array(16),Hl=new Float32Array(9),zl=new Float32Array(4);function $i(o,e,t){const n=o[0];if(n<=0||n>0)return o;const i=e*t;let s=Gl[i];if(s===void 0&&(s=new Float32Array(i),Gl[i]=s),e!==0){n.toArray(s,0);for(let r=1,a=0;r!==e;++r)a+=t,o[r].toArray(s,a)}return s}function dt(o,e){if(o.length!==e.length)return!1;for(let t=0,n=o.length;t<n;t++)if(o[t]!==e[t])return!1;return!0}function ft(o,e){for(let t=0,n=e.length;t<n;t++)o[t]=e[t]}function vs(o,e){let t=Bl[e];t===void 0&&(t=new Int32Array(e),Bl[e]=t);for(let n=0;n!==e;++n)t[n]=o.allocateTextureUnit();return t}function O0(o,e){const t=this.cache;t[0]!==e&&(o.uniform1f(this.addr,e),t[0]=e)}function V0(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(o.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(dt(t,e))return;o.uniform2fv(this.addr,e),ft(t,e)}}function F0(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(o.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(o.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(dt(t,e))return;o.uniform3fv(this.addr,e),ft(t,e)}}function G0(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(o.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(dt(t,e))return;o.uniform4fv(this.addr,e),ft(t,e)}}function B0(o,e){const t=this.cache,n=e.elements;if(n===void 0){if(dt(t,e))return;o.uniformMatrix2fv(this.addr,!1,e),ft(t,e)}else{if(dt(t,n))return;zl.set(n),o.uniformMatrix2fv(this.addr,!1,zl),ft(t,n)}}function k0(o,e){const t=this.cache,n=e.elements;if(n===void 0){if(dt(t,e))return;o.uniformMatrix3fv(this.addr,!1,e),ft(t,e)}else{if(dt(t,n))return;Hl.set(n),o.uniformMatrix3fv(this.addr,!1,Hl),ft(t,n)}}function H0(o,e){const t=this.cache,n=e.elements;if(n===void 0){if(dt(t,e))return;o.uniformMatrix4fv(this.addr,!1,e),ft(t,e)}else{if(dt(t,n))return;kl.set(n),o.uniformMatrix4fv(this.addr,!1,kl),ft(t,n)}}function z0(o,e){const t=this.cache;t[0]!==e&&(o.uniform1i(this.addr,e),t[0]=e)}function W0(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(o.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(dt(t,e))return;o.uniform2iv(this.addr,e),ft(t,e)}}function X0(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(o.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(dt(t,e))return;o.uniform3iv(this.addr,e),ft(t,e)}}function Y0(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(o.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(dt(t,e))return;o.uniform4iv(this.addr,e),ft(t,e)}}function q0(o,e){const t=this.cache;t[0]!==e&&(o.uniform1ui(this.addr,e),t[0]=e)}function j0(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(o.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(dt(t,e))return;o.uniform2uiv(this.addr,e),ft(t,e)}}function K0(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(o.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(dt(t,e))return;o.uniform3uiv(this.addr,e),ft(t,e)}}function Q0(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(o.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(dt(t,e))return;o.uniform4uiv(this.addr,e),ft(t,e)}}function Z0(o,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(o.uniform1i(this.addr,i),n[0]=i);let s;this.type===o.SAMPLER_2D_SHADOW?(Fl.compareFunction=Nc,s=Fl):s=$c,t.setTexture2D(e||s,i)}function $0(o,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(o.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||eu,i)}function J0(o,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(o.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||tu,i)}function em(o,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(o.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||Jc,i)}function tm(o){switch(o){case 5126:return O0;case 35664:return V0;case 35665:return F0;case 35666:return G0;case 35674:return B0;case 35675:return k0;case 35676:return H0;case 5124:case 35670:return z0;case 35667:case 35671:return W0;case 35668:case 35672:return X0;case 35669:case 35673:return Y0;case 5125:return q0;case 36294:return j0;case 36295:return K0;case 36296:return Q0;case 35678:case 36198:case 36298:case 36306:case 35682:return Z0;case 35679:case 36299:case 36307:return $0;case 35680:case 36300:case 36308:case 36293:return J0;case 36289:case 36303:case 36311:case 36292:return em}}function nm(o,e){o.uniform1fv(this.addr,e)}function im(o,e){const t=$i(e,this.size,2);o.uniform2fv(this.addr,t)}function om(o,e){const t=$i(e,this.size,3);o.uniform3fv(this.addr,t)}function sm(o,e){const t=$i(e,this.size,4);o.uniform4fv(this.addr,t)}function rm(o,e){const t=$i(e,this.size,4);o.uniformMatrix2fv(this.addr,!1,t)}function am(o,e){const t=$i(e,this.size,9);o.uniformMatrix3fv(this.addr,!1,t)}function lm(o,e){const t=$i(e,this.size,16);o.uniformMatrix4fv(this.addr,!1,t)}function cm(o,e){o.uniform1iv(this.addr,e)}function um(o,e){o.uniform2iv(this.addr,e)}function hm(o,e){o.uniform3iv(this.addr,e)}function pm(o,e){o.uniform4iv(this.addr,e)}function dm(o,e){o.uniform1uiv(this.addr,e)}function fm(o,e){o.uniform2uiv(this.addr,e)}function mm(o,e){o.uniform3uiv(this.addr,e)}function _m(o,e){o.uniform4uiv(this.addr,e)}function gm(o,e,t){const n=this.cache,i=e.length,s=vs(t,i);dt(n,s)||(o.uniform1iv(this.addr,s),ft(n,s));for(let r=0;r!==i;++r)t.setTexture2D(e[r]||$c,s[r])}function Mm(o,e,t){const n=this.cache,i=e.length,s=vs(t,i);dt(n,s)||(o.uniform1iv(this.addr,s),ft(n,s));for(let r=0;r!==i;++r)t.setTexture3D(e[r]||eu,s[r])}function xm(o,e,t){const n=this.cache,i=e.length,s=vs(t,i);dt(n,s)||(o.uniform1iv(this.addr,s),ft(n,s));for(let r=0;r!==i;++r)t.setTextureCube(e[r]||tu,s[r])}function ym(o,e,t){const n=this.cache,i=e.length,s=vs(t,i);dt(n,s)||(o.uniform1iv(this.addr,s),ft(n,s));for(let r=0;r!==i;++r)t.setTexture2DArray(e[r]||Jc,s[r])}function Em(o){switch(o){case 5126:return nm;case 35664:return im;case 35665:return om;case 35666:return sm;case 35674:return rm;case 35675:return am;case 35676:return lm;case 5124:case 35670:return cm;case 35667:case 35671:return um;case 35668:case 35672:return hm;case 35669:case 35673:return pm;case 5125:return dm;case 36294:return fm;case 36295:return mm;case 36296:return _m;case 35678:case 36198:case 36298:case 36306:case 35682:return gm;case 35679:case 36299:case 36307:return Mm;case 35680:case 36300:case 36308:case 36293:return xm;case 36289:case 36303:case 36311:case 36292:return ym}}class Im{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=tm(t.type)}}class Am{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Em(t.type)}}class vm{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let s=0,r=i.length;s!==r;++s){const a=i[s];a.setValue(e,t[a.id],n)}}}const ar=/(\w+)(\])?(\[|\.)?/g;function Wl(o,e){o.seq.push(e),o.map[e.id]=e}function Tm(o,e,t){const n=o.name,i=n.length;for(ar.lastIndex=0;;){const s=ar.exec(n),r=ar.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&r+2===i){Wl(t,c===void 0?new Im(a,o,e):new Am(a,o,e));break}else{let h=t.map[a];h===void 0&&(h=new vm(a),Wl(t,h)),t=h}}}class fs{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const s=e.getActiveUniform(t,i),r=e.getUniformLocation(t,s.name);Tm(s,r,this)}}setValue(e,t,n,i){const s=this.map[t];s!==void 0&&s.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let s=0,r=t.length;s!==r;++s){const a=t[s],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,s=e.length;i!==s;++i){const r=e[i];r.id in t&&n.push(r)}return n}}function Xl(o,e,t){const n=o.createShader(e);return o.shaderSource(n,t),o.compileShader(n),n}const Sm=37297;let bm=0;function Nm(o,e){const t=o.split(`
`),n=[],i=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let r=i;r<s;r++){const a=r+1;n.push(`${a===e?">":" "} ${a}: ${t[r]}`)}return n.join(`
`)}const Yl=new Ce;function Lm(o){He._getMatrix(Yl,He.workingColorSpace,o);const e=`mat3( ${Yl.elements.map(t=>t.toFixed(4))} )`;switch(He.getTransfer(o)){case _s:return[e,"LinearTransferOETF"];case Je:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",o),[e,"LinearTransferOETF"]}}function ql(o,e,t){const n=o.getShaderParameter(e,o.COMPILE_STATUS),i=o.getShaderInfoLog(e).trim();if(n&&i==="")return"";const s=/ERROR: 0:(\d+)/.exec(i);if(s){const r=parseInt(s[1]);return t.toUpperCase()+`

`+i+`

`+Nm(o.getShaderSource(e),r)}else return i}function Rm(o,e){const t=Lm(e);return[`vec4 ${o}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function wm(o,e){let t;switch(e){case Vu:t="Linear";break;case Fu:t="Reinhard";break;case Gu:t="Cineon";break;case Bu:t="ACESFilmic";break;case Hu:t="AgX";break;case zu:t="Neutral";break;case ku:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+o+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const os=new L;function Cm(){He.getLuminanceCoefficients(os);const o=os.x.toFixed(4),e=os.y.toFixed(4),t=os.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${o}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Dm(o){return[o.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",o.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(mo).join(`
`)}function Pm(o){const e=[];for(const t in o){const n=o[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function Um(o,e){const t={},n=o.getProgramParameter(e,o.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const s=o.getActiveAttrib(e,i),r=s.name;let a=1;s.type===o.FLOAT_MAT2&&(a=2),s.type===o.FLOAT_MAT3&&(a=3),s.type===o.FLOAT_MAT4&&(a=4),t[r]={type:s.type,location:o.getAttribLocation(e,r),locationSize:a}}return t}function mo(o){return o!==""}function jl(o,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return o.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Kl(o,e){return o.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Om=/^[ \t]*#include +<([\w\d./]+)>/gm;function ta(o){return o.replace(Om,Fm)}const Vm=new Map;function Fm(o,e){let t=Pe[e];if(t===void 0){const n=Vm.get(e);if(n!==void 0)t=Pe[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return ta(t)}const Gm=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Ql(o){return o.replace(Gm,Bm)}function Bm(o,e,t,n){let i="";for(let s=parseInt(e);s<parseInt(t);s++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return i}function Zl(o){let e=`precision ${o.precision} float;
...
#define LOW_PRECISION`),e}function km(o){let e="SHADOWMAP_TYPE_BASIC";return o.shadowMapType===dc?e="SHADOWMAP_TYPE_PCF":o.shadowMapType===_u?e="SHADOWMAP_TYPE_PCF_SOFT":o.shadowMapType===Mn&&(e="SHADOWMAP_TYPE_VSM"),e}function Hm(o){let e="ENVMAP_TYPE_CUBE";if(o.envMap)switch(o.envMapMode){case Fi:case Gi:e="ENVMAP_TYPE_CUBE";break;case Es:e="ENVMAP_TYPE_CUBE_UV";break}return e}function zm(o){let e="ENVMAP_MODE_REFLECTION";if(o.envMap)switch(o.envMapMode){case Gi:e="ENVMAP_MODE_REFRACTION";break}return e}function Wm(o){let e="ENVMAP_BLENDING_NONE";if(o.envMap)switch(o.combine){case fc:e="ENVMAP_BLENDING_MULTIPLY";break;case Uu:e="ENVMAP_BLENDING_MIX";break;case Ou:e="ENVMAP_BLENDING_ADD";break}return e}function Xm(o){const e=o.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Ym(o,e,t,n){const i=o.getContext(),s=t.defines;let r=t.vertexShader,a=t.fragmentShader;const l=km(t),c=Hm(t),u=zm(t),h=Wm(t),p=Xm(t),f=Dm(t),_=Pm(s),g=i.createProgram();let m,d,T=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
            ...
            <div style="font-weight: bold; color: lightgray;">${n.data.name}</div>
            `,t=="EXTENDED"?n.data.memo!==null&&(o.innerHTML+=`<div>${n.data.memo}</div>`):n.data.explain!==null&&(o.innerHTML+=`<div>${n.data.explain}</div>`)}Vn.style.display="block"}window.addEventListener("mousemove",o=>{Oi.x=o.clientX/window.innerWidth*2-1,Oi.y=-(o.clientY/window.innerHeight)*2+1,ys.setFromCamera(Oi,rn);const e=ys.intersectObjects(Ji);if(e.length>0){if(yn!==e[0].object)yn=e[0].object;else return;if(!yn.visible)return;Vn.style.left=`${o.clientX+10}px`,Vn.style.top=`${o.clientY+10}px`,ru(Vn,yn,"TOOLTIP"),Vn.style.display="block"}else yn=null,Vn.style.display="none"});const lc=document.getElementById("selected-item");window.addEventListener("click",o=>{Oi.x=o.clientX/window.innerWidth*2-1,Oi.y=-(o.clientY/window.innerHeight)*2+1,ys.setFromCamera(Oi,rn);const e=ys.intersectObjects(Ji);if(e.length>0){if(pr=e[0].object,!pr.visible)return;lc.style.display="flex",ru(lc,pr,"EXTENDED")}});function E9(){const o=Math.min(rn.position.distanceTo(un.target),800),e=Math.max(32*o/700,10);Ji.forEach(t=>{t.scale.set(e,e,e)})}const I9=document.getElementById("filters"),rs=document.getElementById("all-gimmicks"),cc=document.getElementById("collectable"),as=document.getElementById("hidden"),uc=document.getElementById("trap"),A9=document.getElementById("non-filtering"),hc=document.getElementById("slinger"),pc=document.getElementById("endemic");au();function au(o){o!==void 0&&(o.target.classList.contains("all-filters")||rs.checked&&!o.target.checked&&(rs.checked=!1)),rs.checked&&(cc.checked=!0,as.checked=!0,uc.checked=!0,A9.checked=!0,hc.checked=!0,pc.checked=!0),Ji.forEach(e=>{if(e.type==="GIMMICK")switch(Ts.get(e.gimmickId).data.map_filtering_type){case"ALL":e.visible=rs.checked;break;case"COLLECT":e.visible=cc.checked;break;case"ENVIRONMENT_TRAP":e.visible=uc.checked;break;case"INVISIBLE":e.visible=as.checked;break;case"INVISIBLE_ADDBEACON":e.visible=as.checked;break;case"NON_FILTERING_TARGET":e.visible=as.checked;break;case"SLINGER":e.visible=hc.checked;break}else e.type==="ENDEMIC"&&(e.visible=pc.checked)})}I9.addEventListener("change",au);const un=new m6(rn,zn.domElement);un.enable=!0;un.minDistance=100;un.maxDistance=2e3;un.staticMoving=!0;un.zoomSpeed=1.5;rn.position.set(-600,600,1300);un.target.set(-700,0,1400);rn.lookAt(un.target);un.update();const v9=new vp(16777215);ai.add(v9);window.addEventListener("resize",S9);function T9(){un.update(),zn.clear(),E9();const o=rn.position;document.getElementById("camera-position").innerText=`Camera: (${o.x.toFixed(2)}, ${o.y.toFixed(2)}, ${o.z.toFixed(2)})`,zn.render(ai,rn)}function S9(){const o=window.innerWidth,e=window.innerHeight;rn.aspect=o/e,rn.updateProjectionMatrix(),zn.setSize(window.innerWidth,window.innerHeight)}
